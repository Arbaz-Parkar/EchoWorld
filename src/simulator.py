...
from .models import NPC_IDS, ACTIVITIES, WORLD_X, WORLD_Y, NUM_TICKS, ACTIVITY_CHANGE_CHANCE, RANDOM_SEED
...
def run_simulation():
    ...
    npc_states = {
        npc_id: {
            "x": round(random.uniform(*WORLD_X), 2),
            "y": round(random.uniform(*WORLD_Y), 2),
            "activity": "idle"
        }
